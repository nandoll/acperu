<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="UPC.Consciencia.SiteWeb.Account.ForgotPassword" %>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">
                                            Lo entendemos, estas cosas pasan.  
                                            Simplemente ingrese su dirección de correo electrónico a continuación y le enviaremos un enlace 
                                            para restablecer su contraseña!
                                        </p>
                                    </div>
                                    <form id="frmForgotPassword" class="user">
                                        ...
                                        <a href="Login.aspx" class="btn btn-primary btn-user btn-block">Restablecer contraseña</a>
                                    </form>
                                    <hr />
                                    <div class="text-center">
