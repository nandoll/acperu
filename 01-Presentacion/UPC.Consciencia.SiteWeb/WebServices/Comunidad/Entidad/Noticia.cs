...
namespace UPC.Consciencia.SiteWeb.WebServices
{
    ...
    public class Noticia
    {
        ...
        [DataMember(Name = "Medio", Order = 0, IsRequired = true)]
        public String Medio
        {
            get { return m_Medio; }
            set { m_Medio = value; }
        ...
        [DataMember(Name = "FechaHora", Order = 1, IsRequired = true)]
        ...
        [DataMember(Name = "Titulo", Order = 1, IsRequired = true)]
        ...
        [DataMember(Name = "Contenido", Order = 1, IsRequired = true)]
