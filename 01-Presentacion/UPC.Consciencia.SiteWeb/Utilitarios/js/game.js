...
var correctDisplayText = '¡Respuesta Correcta!';
...
//result
var scoreDisplayText = 'Tu score : [NUMBER]!'; //score result display text

//Social share, [SCORE] will replace with game score
var shareEnable = true; //toggle share
var shareTitle = 'El score más alto son [SCORE]pts';//social share score title
var shareMessage = '[SCORE] es mi máximo puntaje en ACPeru ¡Intenta superarme!'; //social share score message
...
function buildCategory(){
	...
	for(var c=0; c<categoryData.thumb; c++){
        var thumbSrc = '../Utilitarios/assets/item_thumb.png';
...
function toggleResult(con){
	if(con){
        $('.itemWinnerCup img').attr('src','../Utilitarios/assets/item_cup.png');	
	}else{
        $('.itemWinnerCup img').attr('src','../Utilitarios/assets/item_cup_over.png');
	}
}
